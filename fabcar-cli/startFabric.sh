...
pushd ../test-network
./network.sh down
# default : channel name -> mychannel, 
./network.sh up createChannel -ca -s couchdb
./network.sh deployCC -ccn ${CC_CHAINCODE_NAME} -ccv 1 -cci initLedger -ccl ${CC_SRC_LANGUAGE} -ccp ${CC_SRC_PATH}
popd
